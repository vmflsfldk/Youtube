...
const translations: Translations = {
  ko: {
    ...
    'nav.live.label': '라이브 방송',
    'nav.live.description': '실시간 방송 중인 아티스트를 확인하세요.',
    ...
    'latest.panel.viewInLibrary': '지금 재생',
    'latest.panel.openInLibrary': '라이브러리에서 보기',
    ...
    'latest.panel.previewLoading': '미리보기를 불러오는 중…',
    'latest.panel.previewUnavailable': '유튜브 영상이 없어 재생할 수 없습니다.',
    'latest.panel.closePreview': '미리보기 닫기',
    'latest.panel.closePreviewAriaLabel': '최신 영상 미리보기를 닫습니다',
    'latest.panel.previewAriaLabel': '최신 영상 미리보기',
    'live.panel.heading': '라이브 방송 중',
    'live.panel.description': '현재 YouTube에서 실시간 방송 중인 아티스트를 모아봤어요.',
    'live.panel.loading': '라이브 방송 정보를 불러오는 중입니다…',
    'live.panel.empty': '현재 진행 중인 라이브 방송이 없습니다.',
    'live.panel.retry': '다시 시도',
    'live.panel.watch': 'YouTube에서 시청',
    'live.panel.startedLabel': '시작:',
    'live.panel.scheduledLabel': '예정:',
    'live.panel.noTiming': '시작 시간이 확인되지 않았습니다.',
    'live.panel.errorFallback': '라이브 방송 정보를 불러오지 못했습니다.',
    'live.panel.untitledStream': '제목 없는 라이브 방송',
  ...
  en: {
    ...
    'nav.live.label': 'Live Streams',
    'nav.live.description': 'See which artists are broadcasting live right now.',
    ...
    'latest.panel.viewInLibrary': 'Play now',
    'latest.panel.openInLibrary': 'View in library',
    ...
    'latest.panel.previewLoading': 'Loading preview…',
    'latest.panel.previewUnavailable':
      'This video cannot be played because no YouTube source is available.',
    'latest.panel.closePreview': 'Close preview',
    'latest.panel.closePreviewAriaLabel': 'Close latest video preview',
    'latest.panel.previewAriaLabel': 'Latest video preview',
    'live.panel.heading': 'Live Streams',
    'live.panel.description': 'Catch artists who are streaming live on YouTube right now.',
    'live.panel.loading': 'Loading live broadcasts…',
    'live.panel.empty': 'No live broadcasts are currently in progress.',
    'live.panel.retry': 'Try again',
    'live.panel.watch': 'Watch on YouTube',
    'live.panel.startedLabel': 'Started:',
    'live.panel.scheduledLabel': 'Scheduled:',
    'live.panel.noTiming': 'Start time unavailable.',
    'live.panel.errorFallback': "We couldn't load live broadcast information.",
    'live.panel.untitledStream': 'Untitled live broadcast',
  ...
  ja: {
    ...
    'nav.live.label': 'ライブ配信',
    'nav.live.description': 'ライブ配信中のアーティストを確認しましょう。',
    ...
    'latest.panel.viewInLibrary': '今すぐ再生',
    'latest.panel.openInLibrary': 'ライブラリで表示',
    ...
    'latest.panel.previewLoading': 'プレビューを読み込み中…',
    'latest.panel.previewUnavailable': 'YouTube動画が見つからないため再生できません。',
    'latest.panel.closePreview': 'プレビューを閉じる',
    'latest.panel.closePreviewAriaLabel': '最新動画のプレビューを閉じる',
    'latest.panel.previewAriaLabel': '最新動画のプレビュー',
    'live.panel.heading': 'ライブ配信中',
    'live.panel.description': '現在 YouTube でライブ配信中のアーティストをまとめました。',
    'live.panel.loading': 'ライブ配信情報を読み込み中です…',
    'live.panel.empty': '現在進行中のライブ配信はありません。',
    'live.panel.retry': '再試行',
    'live.panel.watch': 'YouTubeで視聴',
    'live.panel.startedLabel': '開始:',
    'live.panel.scheduledLabel': '予定:',
    'live.panel.noTiming': '開始時刻を確認できませんでした。',
    'live.panel.errorFallback': 'ライブ配信情報を取得できませんでした。',
    'live.panel.untitledStream': 'タイトル未定のライブ配信',
